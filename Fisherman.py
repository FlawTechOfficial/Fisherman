...
with window("Fisherman Window",width = 600,height = 500):
    ...
    add_slider_int("Max Catch Time",min_value=1,max_value=60,default_value=int(max_catch_time),callback= save_food_time, tip = "Maxmimum time before releasing the rod. Useful if fish can't be caught.")
